-- Data Visibility snapshot #1. Ported from shannon-barrow/databricks-tpc-di
--   src/incremental_batches/audit_validation/Appendix_v1.1.0/AppendixC/tpcdi_visibility_1.sql
-- Records a full set of table row counts (basic + referential-integrity "joined") into
-- DImessages with MessageType='Visibility_1'. run.py runs this after batch 1 and its
-- sibling visibility_2.sql at the very end; the audit's 'Data visibility row counts' /
